...
public class DataBase extends SQLiteOpenHelper {
     ...
     */
    public long createNewTodo(String category, String summary, String description)
    {
    ...
    public Cursor fetchAllReminders() {
        return mDb.query(DATABASE_TABLE, new String[]{COLUMN_ID, COLUMN_CATEGORY,
                    COLUMN_SUMMARY, COLUMN_DESCRIPTION}, null, null, null, null, null);
    }

    public Cursor fetchReminder(long rowId) throws java.sql.SQLException
    {
        Cursor mCursor = mDb.query(true, DATABASE_TABLE, new String[] {COLUMN_ID, COLUMN_CATEGORY,
                COLUMN_SUMMARY, COLUMN_DESCRIPTION},COLUMN_ID + "=" + rowId, null, null, null, null, null);
        if (mCursor != null)
        {
            mCursor.moveToFirst();
        }
